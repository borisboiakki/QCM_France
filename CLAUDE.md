...
│   ├── check_questions_consistency.py           Contrôle des 4 fichiers de questions (ids, propositions, variantes, cohérence inter-QCM, couverture, indice de longueur des propositions)
